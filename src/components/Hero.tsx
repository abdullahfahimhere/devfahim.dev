        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-6 mt-12 lg:mt-16">
              ...
              {/* One-line subtitle */}
<h2 className="text-lg md:text-xl text-muted-foreground font-light whitespace-nowrap">
  Software Engineering Student | Full-Stack Developer | Innovator
</h2>


              {/* Thin paragraph */}
              <p className="text-sm md:text-base text-muted-foreground font-extralight max-w-2xl leading-relaxed">
                Turning ideas into impactful solutions through technology, innovation, and creative
                problem-solving.
              </p>
            </div>

            {/* Achievements inline */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm font-medium">
